    ...
    const mutationDeletedMany = useMutationHooks(
        async (data) => {
            try {
                ...
                console.error("Lỗi khi xóa nhiều sản phẩm:", error.response?.data || error.message);
            }
        }
    );
    ...
    return (
        <div>
            <div>
                ...
                <DrawComponent title='Chi tiết sản phẩm' isOpen={isOpenDraw} onClose={() => setIsOpenDraw(false)} width="80%">
